...
```notes
Browser extensions are awesome because they make our browsing better and more efficient by customizing our browsers.
```
---
...
```notes
Extensions can do pretty cool things on our browsers. Here are a few examples:
```
---
# 🛠 
...
```notes
For example, using Pocket extension you can save online content to your pocket app to consume later
```
---
# ⚙️ 
